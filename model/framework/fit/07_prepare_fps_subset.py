...
DATASET_FILE = os.path.join(root, "..", "..", "checkpoints", "ADB_subset_found_smiles.csv")
...
create_db_file(
    mols_source=mols,
    filename=os.path.join(root, "..", "..", "checkpoints", "fpsim2_database_subset.h5"),
    mol_format='smiles',
    fp_type='Morgan',
    fp_params={'radius': 2, 'fpSize': 1024}
)

with open(os.path.join(root, "..", "..", "checkpoints", "fpsim2_database_smiles_subset.csv"), "w") as f:
    writer = csv.writer(f)
